...
const exec = (command, extraEnv) =>
  execSync(path.resolve(__dirname, "..", "node_modules", ".bin", command), {
    stdio: "inherit",
...
// Generate the icon source code first
require("./generate-icons").then(() => {
  ...
  const size = gzipSize.sync(
    fs.readFileSync(`${DIST_DIR}/dist/macgooey.min.js`)
  );
